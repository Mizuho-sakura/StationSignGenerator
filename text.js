...
document.getElementById("input-bs").addEventListener("input", updatebsspace);

function updatensspace() {
  const text = document.getElementById("input-ns").value;
  const ja = document.getElementById("n_station_ja");
